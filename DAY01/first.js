...
"following_url": "https://api.github.com/users/HamptonMakes/following{/other_user}",
"gists_url": "https://api.github.com/users/HamptonMakes/gists{/gist_id}",
"starred_url": "https://api.github.com/users/HamptonMakes/starred{/owner}{/repo}",
"subscriptions_url": "https://api.github.com/users/HamptonMakes/subscriptions",
...
"received_events_url": "https://api.github.com/users/HamptonMakes/received_events",
"type": "User",
"user_view_type": "public",
"site_admin": false
},
...
"following_url": "https://api.github.com/users/corasaurus-hex/following{/other_user}",
"gists_url": "https://api.github.com/users/corasaurus-hex/gists{/gist_id}",
"starred_url": "https://api.github.com/users/corasaurus-hex/starred{/owner}{/repo}",
"subscriptions_url": "https://api.github.com/users/corasaurus-hex/subscriptions",
...
"received_events_url": "https://api.github.com/users/corasaurus-hex/received_events",
"type": "User",
"user_view_type": "public",
"site_admin": false
},
...
const server = http.createServer((request,response)=>{
    ...
    let num = Number(request.url.slice(1));
        if(isNaN(num || num<=0)){
            response.end("Invalid URL");
            return;
        }
        if(num>100){
            response.end("Above 100 not entertained");
            return;
        }
...
server.listen(3000,()=>{  //object server has a function of listen
